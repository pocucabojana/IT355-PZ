...
public class AdminProduct {
    ...
    public ModelAndView addProduct(@ModelAttribute("product") Product product, ModelAndView model,
        ...
        product.setProductImage("/RentACar/resources/images/" + filename);
...
//        product.setProductImage(product.);
        System.out.println("====GRESKA===== " + request.getParameter("file"));
    ...
    public String deleteProduct(@PathVariable int id, Model model, HttpServletRequest request) {
        ...
        path = Paths.get(rootDirectory + "/RentACar/resources/images/" + id + ".png");
